...
import PersonalMusicCard from './PersonalMusicCard'
            ...
            <div>
                ...
                <Container>
                    ...
                    {props.authorize.userInfo.publicContentItem.map((item, index )=>{
                        return <PersonalMusicCard item={item} index={index} key={index} setPlayTrackId={props.setPlayTrackId} stopPlayer={props.stopPlayer}></PersonalMusicCard>    
                        })} 
                    </Row>
                </Container>
            </div>
...
//     function giveInformationItem(i){
//         item = i
//         handleShow()
//     }
...
//                                         <li onClick={() => {giveInformationItem()}}> <FontAwesomeIcon icon={faInfoCircle} ></FontAwesomeIcon><strong> More info</strong></li>
//                                     </ul>
//                                 </Col>
//                         </Row>
//                             </Col>
